...
/// `isolation:`-taking methods to return a `Sendable` value.
///
...
/// Swift 6.2 on, the closure demonstrably runs in the caller’s isolation domain, its result
/// never leaves that domain, and so the alias is an unconstrained `Any` that requires nothing.
///
