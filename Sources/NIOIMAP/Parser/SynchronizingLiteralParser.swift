...
internal struct SynchronizingLiteralParser {
    ...
    internal struct FramingResult {
        internal var maximumValidBytes: Int
        internal var synchronizingLiteralCount: Int
    }

    internal mutating func parseContinuationsNecessary(_ buffer: ByteBuffer) throws -> FramingResult {
    ...
    internal mutating func consumed(_ numberOfBytes: Int) {
