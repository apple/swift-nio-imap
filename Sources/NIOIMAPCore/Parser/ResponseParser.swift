...
public struct ResponseParser: Parser {
    ...
    public mutating func parseResponseStream(buffer inputBytes: inout ByteBuffer) throws -> _ResponseOrContinuationRequest? {
...
extension ResponseParser {
    fileprivate mutating func parseResponse(state: ResponseState, buffer: inout ParseBuffer, tracker: StackTracker) throws -> _ResponseOrContinuationRequest {
    ...
    private mutating func _parseResponse(buffer: inout ParseBuffer, tracker: StackTracker) throws -> _ResponseOrContinuationRequest {
        func parseResponse_continuation(buffer: inout ParseBuffer, tracker: StackTracker) throws -> _ResponseOrContinuationRequest {
            .continuationRequest(try GrammarParser.parseContinuationRequest(buffer: &buffer, tracker: tracker))
        }

        func parseResponse_tagged(buffer: inout ParseBuffer, tracker: StackTracker) throws -> _ResponseOrContinuationRequest {
