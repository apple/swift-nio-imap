...
let commands: [(String, Command)] = [
    ...
    ("parse_auth_plain_nil", .authenticate(mechanism: .init("PLAIN"), initialClientResponse: nil)),
    ("parse_auth_plain_empty", .authenticate(mechanism: .init("PLAIN"), initialClientResponse: .empty)),
    ("parse_auth_plain_initial data", .authenticate(mechanism: .init("PLAIN"), initialClientResponse: .init(ByteBuffer(string: "dGhpcyBpcyB0ZXN0IGJhc2U2NA==")))),
