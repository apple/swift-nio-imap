...
let commands: [(String, Command)] = [
    ...
    ("parse_rename_params_one", .rename(from: .inbox, to: .init("not an inbox"), params: ["name": nil])),
    ("parse_rename_params_many", .rename(from: .inbox, to: .init("not an inbox"), params: ["name1": nil, "name2": .sequence([1 ... 2, 3 ... 4])])),
