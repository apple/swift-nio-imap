...
let commands: [(String, Command)] = [
    ...
    ("parse_examine_1_param", .examine(.inbox, [.init(key: "param", value: nil)])),
    ("parse_examine_lots_param", .examine(.inbox, [.init(key: "param1", value: nil), .init(key: "param2", value: nil), .init(key: "param3", value: .sequence(.range([1 ... 5, 10 ... 100]))), .init(key: "param4", value: .comp(["str1"]))])),
    ...
    ("parse_select_params_complex", .select(.inbox, [.condstore, .basic(.init(key: "param1", value: nil)), .qresync(.init(uidValiditiy: 123, modificationSequenceValue: .zero, knownUids: [1 ... 3, 5 ... 7, 10 ... 1000], sequenceMatchData: .init(knownSequenceSet: [1 ... 10, 10 ... 20, 30 ... 100], knownUidSet: [100 ... 200, 300 ... 400])))])),
    ...
    ("parse_rename_params_one", .rename(from: .inbox, to: .init("not an inbox"), params: [.init(key: "name", value: nil)])),
    ("parse_rename_params_many", .rename(from: .inbox, to: .init("not an inbox"), params: [.init(key: "name1", value: nil), .init(key: "name2", value: .sequence([1 ... 2, 3 ... 4]))])),
