...
let commands: [(String, Command)] = [
    ...
    ("parse_store_simple_all", .store(.all, [.unchangedSince(.init(modificationSequence: 124))], .flags(.add(silent: false, list: [.answered])))),
    ("parse_store_complex_all", .store(.all, [.unchangedSince(.init(modificationSequence: 124))], .flags(.add(silent: false, list: [.answered, .deleted, .flagged, .seen, .draft])))),
