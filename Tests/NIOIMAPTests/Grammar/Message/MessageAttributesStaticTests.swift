...
extension MessageAttributesStaticTests {
    ...
    func testEncode() {
        let inputs: [(NIOIMAP.MessageAttributesStatic, String, UInt)] = [
            ...
            (.internalDate(NIOIMAP.Date.DateTime(date: .init(day: 25, month: .jun, year: 1994), time: NIOIMAP.Date.Time(hour: 01, minute: 02, second: 03), zone: NIOIMAP.Date.TimeZone(0)!)), #"INTERNALDATE "25-jun-1994 01:02:03 +0000""#, #line),
