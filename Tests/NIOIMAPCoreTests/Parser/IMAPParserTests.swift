    ...
    func testParseSelectParameter() {
        self.iterateTests(
            ...
            validInputs: [
                ...
                ("QRESYNC (1 1 1:2 (* *))", "\r", .qresync(.init(uidValiditiy: 1, modificationSequenceValue: 1, knownUids: .set([1 ... 2]), sequenceMatchData: .init(knownSequenceSet: .set(.all), knownUidSet: .set(.all)))), #line),
            ],
            parserErrorInputs: [
                ("1", "\r", #line),
            ],
...
extension ParserUnitTests {
    func testParseSequenceMatchData() {
        self.iterateTests(
            ...
            validInputs: [
                ("(* *)", "\r", .init(knownSequenceSet: .set(.all), knownUidSet: .set(.all)), #line),
