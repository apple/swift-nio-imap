...
extension ParserUnitTests {
    func testParseIMAPURLSection() {
        self.iterateTests(
            ...
            validInputs: [
                ("/;SECTION=a", " ", IMAPURLSection(encodedSection: .init(section: "a")), #line),
                ("/;SECTION=abc", " ", IMAPURLSection(encodedSection: .init(section: "abc")), #line),
            ],
            parserErrorInputs: [
                ("SECTION=a", " ", #line),
            ],
        ...
        self.iterateTests(
            ...
            validInputs: [
                ...
                (
                    "test/;UID=123/;PARTIAL=1.2",
                    " ",
                    .init(mailboxReference: .init(encodeMailbox: .init(mailbox: "test")), iUID: .init(uid: 123), IMAPURLSection: nil, iPartial: .init(range: .init(offset: 1, length: 2))),
                    #line
                ),
                (
                    "test/;UID=123/;SECTION=section/;PARTIAL=1.2",
                    " ",
                    .init(mailboxReference: .init(encodeMailbox: .init(mailbox: "test")), iUID: .init(uid: 123), IMAPURLSection: .init(encodedSection: .init(section: "section")), iPartial: .init(range: .init(offset: 1, length: 2))),
                    #line
                ),
                (
                    "test/;UIDVALIDITY=123/;UID=123/;SECTION=section/;PARTIAL=1.2",
                    " ",
                    .init(mailboxReference: .init(encodeMailbox: .init(mailbox: "test/"), uidValidity: 123), iUID: .init(uid: 123), IMAPURLSection: .init(encodedSection: .init(section: "section")), iPartial: .init(range: .init(offset: 1, length: 2))),
                    #line
                ),
            ],
            parserErrorInputs: [
