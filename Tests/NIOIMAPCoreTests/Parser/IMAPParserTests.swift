        ...
        self.iterateTests(
            ...
            validInputs: [
                ...
                (
                    ...
                    "\r\n",
                    .list(.init(attributes: [.init("\\oflag1"), .init("\\oflag2")], path: .init(name: .inbox), extensions: [])),
                    #line
                ),
                ...
                (
                    ...
                    "\r\n",
                    .lsub(.init(attributes: [.init("\\seen"), .init("\\draft")], path: .init(name: .inbox), extensions: [])),
                    #line
                ),
                ("SEARCH", "\r\n", .search([]), #line),
                ("SEARCH 1", "\r\n", .search([1]), #line),
        ...
        self.iterateTests(
            ...
            validInputs: [
                (
                    "() NIL inbox",
                    "\r",
                    .init(attributes: [], path: .init(name: .inbox), extensions: []),
                    #line
                ),
                (
                    "() \"d\" inbox",
                    "\r",
                    .init(attributes: [], path: .init(name: .inbox, pathSeparator: "d"), extensions: []),
                    #line
                ),
                (
                    "(\\oflag1 \\oflag2) NIL inbox",
                    "\r",
                    .init(attributes: [.init("\\oflag1"), .init("\\oflag2")], path: .init(name: .inbox), extensions: []),
                    #line
                ),
                (
                    "(\\oflag1 \\oflag2) \"d\" inbox",
                    "\r",
                    .init(attributes: [.init("\\oflag1"), .init("\\oflag2")], path: .init(name: .inbox, pathSeparator: "d"), extensions: []),
                    #line
                ),
            ],
            parserErrorInputs: [],
