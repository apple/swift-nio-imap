        ...
        let inputs: [(String, [ResponseOrContinuationRequest], UInt)] = [
            ...
            (
                ...
                [
                    ...
                    .response(
                        .fetchResponse(.simpleAttribute(.body(.multipart(.init(parts: [
                            .singlepart(.init(type: .text(.init(mediaText: "PLAIN", lineCount: 4078)), fields: .init(parameters: [.init(field: "CHARSET", value: "utf-8")], id: nil, description: nil, encoding: .quotedPrintable, octetCount: 239844), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: nil, language: .init(languages: [], location: .init(location: nil, extensions: [])))))),
                            .singlepart(.init(type: .text(.init(mediaText: "HTML", lineCount: 4078)), fields: .init(parameters: [.init(field: "CHARSET", value: "utf-8")], id: nil, description: nil, encoding: .quotedPrintable, octetCount: 239844), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: nil, language: .init(languages: [], location: .init(location: nil, extensions: [])))))),
                        ...
                        .fetchResponse(
                            .simpleAttribute(.body(.multipart(.init(parts: [
                                ...
                                .multipart(.init(parts: [
                                    ...
                                    .singlepart(.init(type: .text(.init(mediaText: "HTML", lineCount: 32)), fields: .init(parameters: [.init(field: "CHARSET", value: "us-ascii")], id: nil, description: nil, encoding: .quotedPrintable, octetCount: 2217), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: nil, language: .init(languages: [], location: .init(location: nil, extensions: [])))))),
                        ...
                        .fetchResponse(.simpleAttribute(.body(.multipart(.init(parts: [
                            .multipart(
                                .init(parts: [
                                    .multipart(
                                        .init(parts: [
                                            .singlepart(.init(type: .text(.init(mediaText: "PLAIN", lineCount: 20)), fields: .init(parameters: [.init(field: "CHARSET", value: "ISO-8859-1")], id: nil, description: nil, encoding: .quotedPrintable, octetCount: 710), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: nil, language: .init(languages: []))))),
                                            .singlepart(.init(type: .text(.init(mediaText: "HTML", lineCount: 42)), fields: .init(parameters: [.init(field: "CHARSET", value: "ISO-8859-1")], id: nil, description: nil, encoding: .quotedPrintable, octetCount: 4323), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: .init(kind: "INLINE", parameters: []), language: .init(languages: []))))),
                ...
                [
                    ...
                    .response(
                        .fetchResponse(.simpleAttribute(.body(.multipart(.init(parts: [
                            .multipart(
                                .init(parts: [
                                    .singlepart(.init(type: .text(.init(mediaText: "PLAIN", lineCount: 24)), fields: .init(parameters: [.init(field: "CHARSET", value: "ISO-8859-1")], id: nil, description: nil, encoding: .quotedPrintable, octetCount: 410), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: nil, language: .init(languages: []))))),
                                    .singlepart(.init(type: .text(.init(mediaText: "HTML", lineCount: 30)), fields: .init(parameters: [.init(field: "CHARSET", value: "ISO-8859-1")], id: nil, description: nil, encoding: .quotedPrintable, octetCount: 1407), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: .init(kind: "INLINE", parameters: []), language: .init(languages: []))))),
