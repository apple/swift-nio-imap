        ...
        let inputs: [(String, [ResponseOrContinuationRequest], UInt)] = [
                ...
                [
                    ...
                    .response(
                        .fetchResponse(.simpleAttribute(.body(.multipart(.init(parts: [
                            .singlepart(.init(type: .text(.init(mediaText: "PLAIN", lineCount: 47)), fields: .init(parameters: ["CHARSET": "utf-8"], id: nil, contentDescription: nil, encoding: .quotedPrintable, octetCount: 1772), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: nil, language: .init(languages: [], location: .init(location: nil, extensions: [])))))),
                            .singlepart(.init(type: .text(.init(mediaText: "HTML", lineCount: 40)), fields: .init(parameters: ["CHARSET": "utf-8"], id: nil, contentDescription: nil, encoding: .quotedPrintable, octetCount: 2778), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: nil, language: .init(languages: [], location: .init(location: nil, extensions: [])))))),
            ...
            (
                ...
                [
                    ...
                    .response(
                        .fetchResponse(.simpleAttribute(.body(.multipart(.init(parts: [
                            .singlepart(.init(type: .text(.init(mediaText: "HTML", lineCount: 50)), fields: .init(parameters: ["CHARSET": "UTF-8"], id: nil, contentDescription: nil, encoding: .quotedPrintable, octetCount: 3034), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: nil, language: .init(languages: [], location: .init(location: nil, extensions: [])))))),
            ...
            (
                ...
                [
                    ...
                    .response(
                        .fetchResponse(.simpleAttribute(.body(.multipart(.init(parts: [
                            .singlepart(.init(type: .text(.init(mediaText: "PLAIN", lineCount: 5)), fields: .init(parameters: ["CHARSET": "UTF-8"], id: nil, contentDescription: nil, encoding: .sevenBit, octetCount: 221), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: nil, language: .init(languages: [], location: .init(location: nil, extensions: [])))))),
                            .singlepart(.init(type: .text(.init(mediaText: "HTML", lineCount: 20)), fields: .init(parameters: ["CHARSET": "UTF-8"], id: nil, contentDescription: nil, encoding: .sevenBit, octetCount: 2075), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: nil, language: .init(languages: [], location: .init(location: nil, extensions: [])))))),
                        ...
                        .fetchResponse(
                            .simpleAttribute(.body(.multipart(.init(parts: [
                                ...
                                .multipart(.init(parts: [
                                    ...
                                    .singlepart(.init(type: .basic(.init(kind: .application, subtype: .init("OCTET-STREAM"))), fields: .init(parameters: ["X-UNIX-MODE": "0644", "NAME": "Whiteboard on Webex.key"], id: nil, contentDescription: nil, encoding: .base64, octetCount: 4876604), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: .init(kind: "ATTACHMENT", parameters: ["FILENAME": "Whiteboard on Webex.key"]), language: .init(languages: [], location: .init(location: nil, extensions: [])))))),
                                    ...
                                    .singlepart(.init(type: .basic(.init(kind: .application, subtype: .init("PDF"))), fields: .init(parameters: ["X-UNIX-MODE": "0644", "NAME": "Whiteboard on Webex.pdf"], id: nil, contentDescription: nil, encoding: .base64, octetCount: 1191444), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: .init(kind: "INLINE", parameters: ["FILENAME": "Whiteboard on Webex.pdf"]), language: .init(languages: [], location: .init(location: nil, extensions: [])))))),
                                    .singlepart(.init(type: .text(.init(mediaText: "HTML", lineCount: 32)), fields: .init(parameters: ["CHARSET": "us-ascii"], id: nil, contentDescription: nil, encoding: .quotedPrintable, octetCount: 2217), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: nil, language: .init(languages: [], location: .init(location: nil, extensions: [])))))),
                                    .singlepart(.init(type: .basic(.init(kind: .application, subtype: .init("PDF"))), fields: .init(parameters: ["X-UNIX-MODE": "0666", "NAME": "Resume.pdf"], id: nil, contentDescription: nil, encoding: .base64, octetCount: 217550), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: .init(kind: "INLINE", parameters: ["FILENAME": "Resume.pdf"]), language: .init(languages: [], location: .init(location: nil, extensions: [])))))),
                                    .singlepart(.init(type: .text(.init(mediaText: "HTML", lineCount: 62)), fields: .init(parameters: ["CHARSET": "utf-8"], id: nil, contentDescription: nil, encoding: .quotedPrintable, octetCount: 4450), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: nil, language: .init(languages: [], location: .init(location: nil, extensions: [])))))),
                ...
                [
                    ...
                    .response(
                        .fetchResponse(.simpleAttribute(.body(.multipart(.init(parts: [
                            ...
                            .singlepart(
                                .init(type: .basic(.init(kind: .image, subtype: .init("PNG"))), fields: BodyStructure.Fields(parameters: ["NAME": "screenshot.png"], id: "<3__=f2fcxd>", contentDescription: nil, encoding: .base64, octetCount: 40655), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: .init(kind: "INLINE", parameters: ["FILENAME": "screenshot.png"]), language: .init(languages: []))))
                            ),
