        ...
        let inputs: [(String, [ResponseOrContinueRequest], UInt)] = [
                ...
                [
                    ...
                    .response(
                        .fetchResponse(.simpleAttribute(.body(.multipart(.init(parts: [
                            .singlepart(.init(type: .text(.init(mediaText: "PLAIN", lines: 47)), fields: .init(parameter: [.init(field: "CHARSET", value: "utf-8")], id: nil, description: nil, encoding: .quotedPrintable, octets: 1772), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: nil, language: .init(languages: [], location: .init(location: nil, extensions: [])))))),
                            .singlepart(.init(type: .text(.init(mediaText: "HTML", lines: 40)), fields: .init(parameter: [.init(field: "CHARSET", value: "utf-8")], id: nil, description: nil, encoding: .quotedPrintable, octets: 2778), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: nil, language: .init(languages: [], location: .init(location: nil, extensions: [])))))),
            ...
            (
                ...
                [
                    ...
                    .response(
                        .fetchResponse(.simpleAttribute(.body(.multipart(.init(parts: [
                            .singlepart(.init(type: .text(.init(mediaText: "PLAIN", lines: 5)), fields: .init(parameter: [.init(field: "CHARSET", value: "UTF-8")], id: nil, description: nil, encoding: .sevenBit, octets: 221), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: nil, language: .init(languages: [], location: .init(location: nil, extensions: [])))))),
                            .singlepart(.init(type: .text(.init(mediaText: "HTML", lines: 20)), fields: .init(parameter: [.init(field: "CHARSET", value: "UTF-8")], id: nil, description: nil, encoding: .sevenBit, octets: 2075), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: nil, language: .init(languages: [], location: .init(location: nil, extensions: [])))))),
            ...
            (
                ...
                [
                    ...
                    .response(
                        .fetchResponse(.simpleAttribute(.body(.multipart(.init(parts: [
                            .singlepart(.init(type: .text(.init(mediaText: "PLAIN", lines: 4078)), fields: .init(parameter: [.init(field: "CHARSET", value: "utf-8")], id: nil, description: nil, encoding: .quotedPrintable, octets: 239844), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: nil, language: .init(languages: [], location: .init(location: nil, extensions: [])))))),
            ...
            (
                ...
                [
                    ...
                    .response(
                        .fetchResponse(.simpleAttribute(.body(.singlepart(.init(type: .text(.init(mediaText: "HTML", lines: 603)), fields: .init(parameter: [], id: nil, description: nil, encoding: .binary, octets: 28803), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: nil, language: .init(languages: [], location: .init(location: nil, extensions: [])))))), structure: true)))
                    ),
                    .response(.fetchResponse(.finish)),
                ],
                #line
                    ...
                    .response(
                        .fetchResponse(
                            .simpleAttribute(.body(.multipart(.init(parts: [
                                .singlepart(.init(type: .text(.init(mediaText: "PLAIN", lines: 170)), fields: .init(parameter: [.init(field: "CHARSET", value: "utf-8")], id: nil, description: nil, encoding: .quotedPrintable, octets: 6990), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: nil, language: .init(languages: [], location: .init(location: nil, extensions: [])))))),
                                .multipart(.init(parts: [
                                    .singlepart(.init(type: .text(.init(mediaText: "HTML", lines: 274)), fields: .init(parameter: [.init(field: "CHARSET", value: "utf-8")], id: nil, description: nil, encoding: .quotedPrintable, octets: 18865), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: nil, language: .init(languages: [], location: .init(location: nil, extensions: [])))))),
                                    .singlepart(.init(type: .basic(.init(type: .application, subtype: .init("OCTET-STREAM"))), fields: .init(parameter: [.init(field: "X-UNIX-MODE", value: "0644"), .init(field: "NAME", value: "Whiteboard on Webex.key")], id: nil, description: nil, encoding: .base64, octets: 4876604), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: .init(string: "ATTACHMENT", parameter: [.init(field: "FILENAME", value: "Whiteboard on Webex.key")]), language: .init(languages: [], location: .init(location: nil, extensions: [])))))),
                                    .singlepart(.init(type: .text(.init(mediaText: "HTML", lines: 17)), fields: .init(parameter: [.init(field: "CHARSET", value: "us-ascii")], id: nil, description: nil, encoding: .quotedPrintable, octets: 1143), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: nil, language: .init(languages: [], location: .init(location: nil, extensions: [])))))),
                                    .singlepart(.init(type: .basic(.init(type: .application, subtype: .init("PDF"))), fields: .init(parameter: [.init(field: "X-UNIX-MODE", value: "0644"), .init(field: "NAME", value: "Whiteboard on Webex.pdf")], id: nil, description: nil, encoding: .base64, octets: 1191444), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: .init(string: "INLINE", parameter: [.init(field: "FILENAME", value: "Whiteboard on Webex.pdf")]), language: .init(languages: [], location: .init(location: nil, extensions: [])))))),
                                    .singlepart(.init(type: .text(.init(mediaText: "HTML", lines: 32)), fields: .init(parameter: [.init(field: "CHARSET", value: "us-ascii")], id: nil, description: nil, encoding: .quotedPrintable, octets: 2217), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: nil, language: .init(languages: [], location: .init(location: nil, extensions: [])))))),
                                    .singlepart(.init(type: .basic(.init(type: .application, subtype: .init("PDF"))), fields: .init(parameter: [.init(field: "X-UNIX-MODE", value: "0666"), .init(field: "NAME", value: "Resume.pdf")], id: nil, description: nil, encoding: .base64, octets: 217550), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: .init(string: "INLINE", parameter: [.init(field: "FILENAME", value: "Resume.pdf")]), language: .init(languages: [], location: .init(location: nil, extensions: [])))))),
                                    .singlepart(.init(type: .text(.init(mediaText: "HTML", lines: 62)), fields: .init(parameter: [.init(field: "CHARSET", value: "utf-8")], id: nil, description: nil, encoding: .quotedPrintable, octets: 4450), extension: .init(fieldMD5: nil, dispositionAndLanguage: .init(disposition: nil, language: .init(languages: [], location: .init(location: nil, extensions: [])))))),
