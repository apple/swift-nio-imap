    ...
    func testParseSearchKey() {
        self.iterateTests(
            ...
            validInputs: [
                ...
                ("DRAFT", "\r", .draft, #line),
                ("ON 25-jun-1994", "\r", .on(IMAPDate(year: 1994, month: 6, day: 25)!), #line),
                ("SINCE 01-jan-2001", "\r", .since(IMAPDate(year: 2001, month: 1, day: 1)!), #line),
                ("SENTON 02-jan-2002", "\r", .sentOn(IMAPDate(year: 2002, month: 1, day: 2)!), #line),
                ("SENTBEFORE 03-jan-2003", "\r", .sentBefore(IMAPDate(year: 2003, month: 1, day: 3)!), #line),
                ("SENTSINCE 04-jan-2004", "\r", .sentSince(IMAPDate(year: 2004, month: 1, day: 4)!), #line),
                ("BEFORE 05-jan-2005", "\r", .before(IMAPDate(year: 2005, month: 1, day: 5)!), #line),
