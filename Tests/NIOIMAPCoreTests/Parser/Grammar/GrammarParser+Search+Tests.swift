    ...
    func testParseSearchReturnData() {
        self.iterateTests(
            ...
            validInputs: [
                ...
                ("PARTIAL (1:10 108595)", "\r", .partial(PartialRange.first(1...10), [108595]), #line),
                ("PARTIAL (-2:-20 20:24,108595)", "\r", .partial(PartialRange.last(2...20), [20...24, 108595]), #line),
                ("PARTIAL (1:10 NIL)", "\r", .partial(PartialRange.first(1...10), []), #line),
