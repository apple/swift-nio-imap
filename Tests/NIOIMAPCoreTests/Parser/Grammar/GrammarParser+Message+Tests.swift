    ...
    func testParseMessageAttribute() throws {
        ...
        self.iterateTests(
            ...
            validInputs: [
                ...
                // qq.com can return a day without a leading zero
                (#"INTERNALDATE "8-Mar-2023 12:16:47 +0800""#, " ", .internalDate(date2), #line),
                ...
                ("X-GM-MSGID 1278455344230334865", " ", .gmailMessageID(1_278_455_344_230_334_865), #line),
                ("X-GM-THRID 1278455344230334865", " ", .gmailThreadID(1_278_455_344_230_334_865), #line),
                (
