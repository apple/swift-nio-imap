    ...
    func testParseCommandAuth() {
        self.iterateTests(
            ...
            validInputs: [
                ...
                ("GENURLAUTH test INTERNAL", "\r", .generateAuthorizationURL([.init(urlRump: "test", mechanism: .internal)]), #line),
                ("GENURLAUTH test INTERNAL test2 INTERNAL", "\r", .generateAuthorizationURL([.init(urlRump: "test", mechanism: .internal), .init(urlRump: "test2", mechanism: .internal)]), #line),
