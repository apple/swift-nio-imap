...
struct ResponseTextCodeTests {
    ...
    @Test(arguments: [
        ...
        ParseFixture.responseTextCode("APPENDUID 1234 4:5", expected: .success(.uidAppend(.init(uidValidity: 1234, uids: [4, 5])))),
        ...
        ParseFixture.responseTextCode("BADCHARSET (UTF8 UTF9 UTF10)", expected: .success(.badCharset(["UTF8", "UTF9", "UTF10"]))),
        ...
        ParseFixture.responseTextCode("CAPABILITY IMAP4 IMAP4rev1", expected: .success(.capability([.imap4, .imap4rev1]))),
        ...
        ParseFixture.responseTextCode("COPYUID 443 3:5 6:8", expected: .success(.uidCopy(.init(destinationUIDValidity: 443, sourceUIDs: [3...5], destinationUIDs: [6...8])))),
        ...
        ParseFixture.responseTextCode("HIGHESTMODSEQ 1", expected: .success(.highestModificationSequence(.init(integerLiteral: 1)))),
        ParseFixture.responseTextCode("INUSE", expected: .success(.inUse)),
        ParseFixture.responseTextCode("LIMIT", expected: .success(.limit)),
        ParseFixture.responseTextCode("MAILBOXID (F2212ea87-6097-4256-9d51-71338625)", expected: .success(.mailboxID("F2212ea87-6097-4256-9d51-71338625"))),
        ...
        ParseFixture.responseTextCode("NAMESPACE NIL NIL NIL", expected: .success(.namespace(.init(userNamespace: [], otherUserNamespace: [], sharedNamespace: [])))),
        ParseFixture.responseTextCode(#"NAMESPACE (("Foo" NIL)) NIL (("Bar" NIL))"#, expected: .success(.namespace(.init(userNamespace: [.init(string: "Foo", responseExtensions: [:])], otherUserNamespace: [], sharedNamespace: [.init(string: "Bar", char: nil, responseExtensions: [:])])))),
        ...
        ParseFixture.responseTextCode(#"PERMANENTFLAGS (\Answered \Seen \*)"#, expected: .success(.permanentFlags([.flag(.answered), .flag(.seen), .wildcard]))),
        ParseFixture.responseTextCode(#"PERMANENTFLAGS (\Answered)"#, expected: .success(.permanentFlags([.flag(.answered)]))),
        ...
        ParseFixture.responseTextCode("REFERRAL imap://localhost/", expected: .success(.referral(.init(server: .init(host: "localhost"), query: nil)))),
        ...
        ParseFixture.responseTextCode("URLMECH INTERNAL INTERNAL", expected: .success(.urlMechanisms([.init(mechanism: .internal, base64: nil)]))),
        ParseFixture.responseTextCode("URLMECH INTERNAL INTERNAL=YQ==", expected: .success(.urlMechanisms([.init(mechanism: .internal, base64: "a")]))),
