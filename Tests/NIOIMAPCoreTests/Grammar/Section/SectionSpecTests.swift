...
private struct SectionSpecifierTests {
    ...
    @Test(
        "comparable SectionSpecifier Kind",
        arguments: [
            ...
            ComparableFixture<SectionSpecifier.Kind>(
                lhs: .headerFields([]),
                rhs: .headerFieldsNot([]),
                expected: false
            ),
    ...
    @Test(
        "comparable SectionSpecifier Part",
        arguments: [
