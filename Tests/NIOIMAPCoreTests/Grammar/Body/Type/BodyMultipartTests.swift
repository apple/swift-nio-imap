...
extension BodyMultipartTests {
    func testEncode() {
        let inputs: [(BodyStructure.Multipart, String, UInt)] = [
            (
                .init(parts: [
                    .singlepart(BodyStructure.Singlepart(type: .text(.init(mediaText: "subtype", lineCount: 5)), fields: .init(parameters: [], id: nil, description: nil, encoding: .base64, octetCount: 6), extension: nil)),
            ...
            (
                .init(parts: [
                    .singlepart(BodyStructure.Singlepart(type: .text(.init(mediaText: "subtype", lineCount: 5)), fields: .init(parameters: [], id: nil, description: nil, encoding: .base64, octetCount: 6), extension: nil)),
                    .singlepart(BodyStructure.Singlepart(type: .text(.init(mediaText: "subtype", lineCount: 6)), fields: .init(parameters: [], id: nil, description: nil, encoding: .base64, octetCount: 7), extension: nil)),
