...
extension SearchKeyTests {
    func testEncode() {
        let inputs: [(SearchKey, String, UInt)] = [
            ...
            (.before(Date(day: 25, month: 6, year: 1994)!), "BEFORE 25-jun-1994", #line),
            ...
            (.on(Date(day: 16, month: 9, year: 1999)!), "ON 16-sep-1999", #line),
            (.since(Date(day: 17, month: 1, year: 1984)!), "SINCE 17-jan-1984", #line),
            ...
            (.sent(.on(Date(day: 7, month: 12, year: 2018)!)), "SENTON 7-dec-2018", #line),
            (.smaller(555), "SMALLER 555", #line),
            (.uid(UIDSet(333 ... 444)), "UID 333:444", #line),
            (.sequenceSet(SequenceSet(...222)), "1:222", #line),
            (.sequenceSet(SequenceSet(222...)), "222:*", #line),
            (.array([]), "()", #line),
