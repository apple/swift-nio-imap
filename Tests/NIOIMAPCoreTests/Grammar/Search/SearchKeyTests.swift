...
extension SearchKeyTests {
    func testEncode() {
        let inputs: [(SearchKey, String, UInt)] = [
            ...
            (.before(IMAPDate(year: 1994, month: 6, day: 25)!), "BEFORE 25-Jun-1994", #line),
            ...
            (.on(IMAPDate(year: 1999, month: 9, day: 16)!), "ON 16-Sep-1999", #line),
            (.since(IMAPDate(year: 1984, month: 1, day: 17)!), "SINCE 17-Jan-1984", #line),
            ...
            (.sentOn(IMAPDate(year: 2018, month: 12, day: 7)!), "SENTON 7-Dec-2018", #line),
            (.sentBefore(IMAPDate(year: 2018, month: 12, day: 7)!), "SENTBEFORE 7-Dec-2018", #line),
            (.sentSince(IMAPDate(year: 2018, month: 12, day: 7)!), "SENTSINCE 7-Dec-2018", #line),
