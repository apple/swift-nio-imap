...
extension CommandType_Tests {
    func testEncode() {
        let inputs: [(Command, CommandEncodingOptions, [String], UInt)] = [
            ...
            (.fetch(.set([77]), [.uid, .bodySection(peek: true, .header, nil)], [.changedSince(707484939116871680)]), CommandEncodingOptions(), ["FETCH 77 (UID INTERNALDATE) (CHANGEDSINCE 707484939116871680)"], #line),
            ...
            (.generateAuthorizedURL([.init(urlRump: "rump1", mechanism: .internal)]), CommandEncodingOptions(), ["GENURLAUTH \"rump1\" INTERNAL"], #line),
            (.generateAuthorizedURL([.init(urlRump: "rump2", mechanism: .internal), .init(urlRump: "rump3", mechanism: .init("test"))]), CommandEncodingOptions(), ["GENURLAUTH \"rump2\" INTERNAL \"rump3\" test"], #line),
