...
extension CommandType_Tests {
    func testEncode() {
        let inputs: [(Command, CommandEncodingOptions, [String], UInt)] = [
            ...
            (.fetch(.set([77]), [.uid, .bodySection(peek: true, .header)], [.changedSince(707484939116871680)]), CommandEncodingOptions(), ["FETCH 77 (UID INTERNALDATE) (CHANGEDSINCE 707484939116871680)"], #line),
