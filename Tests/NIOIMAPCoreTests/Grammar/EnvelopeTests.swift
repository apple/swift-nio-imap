        ...
        let inputs: [(Envelope, String, UInt)] = [
            ...
            (
                Envelope(
                    ...
                    to: [.singleAddress(.init(personName: "name4", sourceRoot: "adl4", mailbox: "mailbox4", host: "host4"))],
                    cc: [.singleAddress(.init(personName: "name5", sourceRoot: "adl5", mailbox: "mailbox5", host: "host5"))],
                    bcc: [.singleAddress(.init(personName: "name6", sourceRoot: "adl6", mailbox: "mailbox6", host: "host6"))],
