...
extension MessageAttributesTests {
    func testEncode() throws {
        ...
        let inputs: [(MessageAttribute, String, UInt)] = [
            ...
            (.envelope(Envelope(date: "date", subject: "subject", from: [.init(personName: "name", sourceRoot: "adl", mailbox: "mailbox", host: "host")], sender: [.init(personName: "name", sourceRoot: "adl", mailbox: "mailbox", host: "host")], reply: [.init(personName: "name", sourceRoot: "adl", mailbox: "mailbox", host: "host")], to: [.init(personName: "name", sourceRoot: "adl", mailbox: "mailbox", host: "host")], cc: [.init(personName: "name", sourceRoot: "adl", mailbox: "mailbox", host: "host")], bcc: [.init(personName: "name", sourceRoot: "adl", mailbox: "mailbox", host: "host")], inReplyTo: "replyto", messageID: "abc123")), "ENVELOPE (\"date\" \"subject\" ((\"name\" \"adl\" \"mailbox\" \"host\")) ((\"name\" \"adl\" \"mailbox\" \"host\")) ((\"name\" \"adl\" \"mailbox\" \"host\")) ((\"name\" \"adl\" \"mailbox\" \"host\")) ((\"name\" \"adl\" \"mailbox\" \"host\")) ((\"name\" \"adl\" \"mailbox\" \"host\")) \"replyto\" \"abc123\")", #line),
