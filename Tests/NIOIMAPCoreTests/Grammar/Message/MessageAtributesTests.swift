...
extension MessageAttributesTests {
    func testEncode() throws {
        ...
        let inputs: [(MessageAttribute, String, UInt)] = [
            ...
            (.envelope(Envelope(date: "date", subject: "subject", from: [.address(.init(personName: "name", sourceRoot: "adl", mailbox: "mailbox", host: "host"))], sender: [.address(.init(personName: "name", sourceRoot: "adl", mailbox: "mailbox", host: "host"))], reply: [.address(.init(personName: "name", sourceRoot: "adl", mailbox: "mailbox", host: "host"))], to: [.address(.init(personName: "name", sourceRoot: "adl", mailbox: "mailbox", host: "host"))], cc: [.address(.init(personName: "name", sourceRoot: "adl", mailbox: "mailbox", host: "host"))], bcc: [.address(.init(personName: "name", sourceRoot: "adl", mailbox: "mailbox", host: "host"))], inReplyTo: "replyto", messageID: "abc123")), "ENVELOPE (\"date\" \"subject\" ((\"name\" \"adl\" \"mailbox\" \"host\")) ((\"name\" \"adl\" \"mailbox\" \"host\")) ((\"name\" \"adl\" \"mailbox\" \"host\")) ((\"name\" \"adl\" \"mailbox\" \"host\")) ((\"name\" \"adl\" \"mailbox\" \"host\")) ((\"name\" \"adl\" \"mailbox\" \"host\")) \"replyto\" \"abc123\")", #line),
